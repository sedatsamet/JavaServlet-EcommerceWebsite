...
<body>
	<div class="container text-center">
		...
		<hr>
		<span style="margin-left:55px;">If you do not have an account</span> <br> <a
			href="register.jsp" style="margin-left:55px;"><button class="btn btn-lg btn-primary btn-block">Sign
				up</button></a>
	</div>
